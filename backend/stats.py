...
from utils_pdf import build_report_pdf  # ⚠️ Đảm bảo file tên utils_pdf.py
import io
...
def stats_report():
  _require_admin()
  # Dùng chuỗi rỗng nếu không truyền ngày -> utils_pdf sẽ ẩn dòng Period
  ...
  # Đặt tên file theo mốc ngày nếu có
  fname = "report.pdf"
